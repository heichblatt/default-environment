...
gsettings set org.gnome.shell favorite-apps "['iceweasel.desktop', 'sublime.desktop', 'nautilus.desktop', 'gnome-terminal.desktop', 'icedove.desktop', 'empathy.desktop', 'quodlibet.desktop']"
